...
$plugin->version   = 2016102700;        // The current module version (Date: YYYYMMDDXX)
...
$plugin->release   = '2.7.002';         // Don't limit the frequency at which the CRON gets called (it will look after it for itself)
